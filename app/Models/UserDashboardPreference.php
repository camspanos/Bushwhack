...
class UserDashboardPreference extends Model
{
    ...
    {
        // Default layout based on user 1's optimized configuration
        return [
            // Row 1: Key stats (4 cards, size 3 each = full row)
            ...
            // Row 2: Biggest catches + species chart
            ...
            // Row 3: Trip stats (3 cards, size 4 each = full row)
            ...
            // Row 4: Day stats (4 cards, size 3 each = full row)
            ...
            // Row 5: Time-based charts (3 cards, size 4 each = full row)
            ...
            // Row 6: Fly stats (4 cards, size 3 each = full row)
            ...
            // Row 7-8: Species and location tables (2 cards per row, size 6 each)
            ...
            // Row 9: Weather cards (4 cards, size 3 each = full row)
            ['card_id' => 'best_cloud_cover', 'order' => 26, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_wind_condition', 'order' => 27, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'catches_by_precipitation', 'order' => 28, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_barometric_pressure', 'order' => 29, 'is_visible' => true, 'size' => 3],
            // Row 10: Water condition cards (4 cards, size 3 each = full row)
            ['card_id' => 'best_water_clarity', 'order' => 30, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'catches_by_water_level', 'order' => 31, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_water_speed', 'order' => 32, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_surface_condition', 'order' => 33, 'is_visible' => true, 'size' => 3],
            // Row 11: Moon position cards (3 cards, size 4 each = full row)
            ['card_id' => 'catches_by_moon_position', 'order' => 34, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'major_vs_minor_feeding', 'order' => 35, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'best_moon_for_big_fish', 'order' => 36, 'is_visible' => true, 'size' => 4],
            // Row 12: Tide + Weight cards
            ['card_id' => 'catches_by_tide', 'order' => 37, 'is_visible' => true, 'size' => 3],
            ...
            // Row 13: Friend cards (4 cards, size 3 each = full row)
            ['card_id' => 'most_productive_buddy', 'order' => 41, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'solo_vs_group', 'order' => 42, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'lucky_charm_friend', 'order' => 43, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'most_successful_rod', 'order' => 44, 'is_visible' => true, 'size' => 3],
            // Row 14: Rod and style cards (4 cards, size 3 each = full row)
            ['card_id' => 'best_rod_for_trophies', 'order' => 45, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'catches_by_style', 'order' => 46, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'most_successful_style', 'order' => 47, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_hour', 'order' => 48, 'is_visible' => true, 'size' => 3],
            // Row 15: Combined analysis cards (2 cards, size 6 each = full row)
            ['card_id' => 'golden_conditions', 'order' => 49, 'is_visible' => true, 'size' => 6],
            ['card_id' => 'best_conditions_summary', 'order' => 50, 'is_visible' => true, 'size' => 6],
            // Row 16: Time & Pattern Analysis cards
            ['card_id' => 'time_blocks', 'order' => 51, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_day_of_month', 'order' => 52, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'seasonal_trends', 'order' => 53, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'consecutive_days_streak', 'order' => 54, 'is_visible' => true, 'size' => 3],
            // Row 17: More time/location cards
            ['card_id' => 'days_since_skunk', 'order' => 55, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'location_variety', 'order' => 56, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'most_consistent_spot', 'order' => 57, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'underexplored_spots', 'order' => 58, 'is_visible' => true, 'size' => 3],
            // Row 18: Location cards
            ['card_id' => 'best_location_by_season', 'order' => 59, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'new_spot_success_rate', 'order' => 60, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'species_diversity', 'order' => 61, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'rarest_catches', 'order' => 62, 'is_visible' => true, 'size' => 3],
            // Row 19: Species Deep Dive cards
            ['card_id' => 'species_streak', 'order' => 63, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'new_species_this_year', 'order' => 64, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'size_improvement', 'order' => 65, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'fly_rotation', 'order' => 66, 'is_visible' => true, 'size' => 3],
            // Row 20: Fly/Lure Pattern cards
            ['card_id' => 'one_hit_wonders', 'order' => 67, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'reliable_producers', 'order' => 68, 'is_visible' => true, 'size' => 3],
            ...
            ['card_id' => 'lucky_number', 'order' => 71, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_fly_by_species', 'order' => 72, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'yoy_comparison', 'order' => 73, 'is_visible' => true, 'size' => 4],
            // Row 22: Progress & Goals cards
            ['card_id' => 'personal_bests', 'order' => 74, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'fishing_frequency', 'order' => 75, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'wind_cloud_combo', 'order' => 76, 'is_visible' => true, 'size' => 3],
            // Row 23: Environmental Combo cards
            ['card_id' => 'moon_time_combo', 'order' => 77, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'water_weather_combo', 'order' => 78, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'fishing_score', 'order' => 79, 'is_visible' => true, 'size' => 3],
            // Row 24: Gamification cards
            ['card_id' => 'badges', 'order' => 80, 'is_visible' => true, 'size' => 6],
            ['card_id' => 'hot_streak', 'order' => 81, 'is_visible' => true, 'size' => 3],
        ];
    }
    ...
    public static function getCardSizes(): array
    {
        return [
            ...
            // Rod and style cards (all size 3)
            ...
            'size_improvement' => 3,
            // Fly/Lure Pattern cards (all size 3)
            'fly_rotation' => 3,
            'one_hit_wonders' => 3,
            'reliable_producers' => 3,
            'best_fly_by_location' => 3,
