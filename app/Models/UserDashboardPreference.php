...
class UserDashboardPreference extends Model
{
    ...
    {
        // Default layout based on user 1's optimized configuration (94 cards)
        return [
            ...
            ['card_id' => 'top_species_by_count', 'order' => 19, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'top_species_by_size', 'order' => 20, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'top_locations_by_count', 'order' => 21, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'top_locations_by_size', 'order' => 22, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'heaviest_catch', 'order' => 23, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'avg_weight_trend', 'order' => 24, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'total_weight', 'order' => 25, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'avg_weight_by_species', 'order' => 26, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'seasonal_trends', 'order' => 27, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'best_location_by_season', 'order' => 28, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'yoy_comparison', 'order' => 29, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'fishing_frequency', 'order' => 30, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'catches_by_moon_position', 'order' => 31, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'major_vs_minor_feeding', 'order' => 32, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'best_moon_for_big_fish', 'order' => 33, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'location_variety', 'order' => 34, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'new_spot_success_rate', 'order' => 35, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'stats_favorite_location', 'order' => 36, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'underexplored_spots', 'order' => 37, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'most_consistent_spot', 'order' => 38, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'multi_species_days', 'order' => 39, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'most_species_in_day', 'order' => 40, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'weekend_warrior', 'order' => 41, 'is_visible' => true, 'size' => 3],
            ...
            ['card_id' => 'fly_size_by_species', 'order' => 88, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'fly_size_by_season', 'order' => 89, 'is_visible' => true, 'size' => 4],
            ['card_id' => 'best_fly_size', 'order' => 90, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'big_fish_air_temp', 'order' => 91, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'hot_streak', 'order' => 92, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'temp_sweet_spot', 'order' => 93, 'is_visible' => true, 'size' => 3],
            ['card_id' => 'badges', 'order' => 94, 'is_visible' => true, 'size' => 12],
        ];
    }
    ...
    public static function getCardDisplayNames(): array
    {
        return [
            ...
            'most_species_in_day' => 'Most Species in a Day',
