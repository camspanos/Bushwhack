...
const FishingLogsController = { availableYears, calculateTimeOfDay, calculateMoonPosition, index, create, store, show, edit, update, destroy }

export default FishingLogsController