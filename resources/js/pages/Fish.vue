...
import { Fish as FishIcon, Plus, Pencil, Trash2, Table as TableIcon, BarChart3, TrendingUp, Award, Calendar as CalendarIcon, AlertCircle, Crown } from 'lucide-vue-next';
...
onMounted(async () => {
    ...
    fetchFishStats(); // Now fetch stats with the correct default year
});
</script>
