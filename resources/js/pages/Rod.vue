...
import { Wrench, Plus, Pencil, Trash2, Table as TableIcon, BarChart3, Fish, TrendingUp, Award, Calendar as CalendarIcon, AlertCircle, Crown } from 'lucide-vue-next';
...
onMounted(async () => {
    ...
    fetchEquipmentStats(); // Now fetch stats with the correct default year
});
</script>
                ...
                <Tabs default-value="table" class="w-full">
                    ...
                    <TabsContent value="dashboard" class="mt-0">
                        <div class="space-y-6">
                                ...
                                <Card v-for="equip in equipmentStats" :key="equip.id" class="bg-gradient-to-br from-teal-50/30 to-transparent dark:from-teal-950/10">
                                    ...
                                    <CardContent class="pt-0 -mt-2 space-y-3">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="font-bold text-blue-700 dark:text-blue-300">{{ equip.totalTrips }}</span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <span class="text-sm text-muted-foreground flex items-center gap-2">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="font-bold text-red-700 dark:text-red-300">{{ equip.successRate }}%</span>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
                            ...
                            <!-- Empty State -->
                            <Card v-if="equipmentStats.length === 0" class="bg-gradient-to-br from-gray-50/30 to-transparent dark:from-gray-950/10">
